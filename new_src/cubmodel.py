...
class ClassificationHead(nn.Module):
    def __init__(self, embedding_dim=DIM, intermediate_dim=INT_DIM, num_classes=CUB_CLASSES):
        super().__init__()
        self.embedding_dim = embedding_dim
...
class AttributeEmbeddingNetwork(nn.Module):
    def __init__(self, input_size=CUB_ATTR, embedding_dim=DIM, output_size=ATTR_EMB):
        super().__init__()
        self.embedding_dim = embedding_dim
